...
var CLIRunner = /** @class */ (function () {
    ...
    CLIRunner.prototype.configureProgram = function () {
        ...
        program
            ...
            .option('-a, --authenticationPath <path/to/authentication.json>', 'JSON file that contains private key and client email')
            ...
            .option('-o, --obbFilePaths <path/to.obb>..<path/to.obb>', 'OBBs to upload (optional)', this.collectParameterValues)
