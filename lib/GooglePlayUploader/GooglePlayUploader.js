            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [
                            4 /*yield*/,
                            this.uploadMultiplePaths(this._gPlayUploaderConfig.apkFiles, this.uploadSingleAPK)
                        ];
                    case 4:
                        _b.sent();
                        return [
                            4 /*yield*/,
                            this.uploadMultiplePaths(this._gPlayUploaderConfig.obbFiles, this.uploadSingleOBB)
                        ];
                    case 5:
                        _b.sent();
                ...
                pathsToUpload.forEach(function(filePath) {
                    return __awaiter(_this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(_a) {
                            switch (_a.label) {
                                case 0:
                                    return [4 /*yield*/, uploadSinglePathFunction(filePath)];
                                case 1:
