...
var adbkit_apkreader_1 = require("adbkit-apkreader");
var fs_1 = require("fs");
...
var GPlayUploader = /** @class */ (function () {
    ...
    GPlayUploader.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.parseManifest()];
                    case 1:
                        _b.sent();
                        _a = this;
                    ...
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this.uploadMultiplePaths(this._gPlayUploaderConfig.apkFiles, this.uploadSingleAPK)];
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, this.uploadMultiplePaths(this._gPlayUploaderConfig.obbFiles, this.uploadSingleOBB)];
                    case 5:
                        _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, adbkit_apkreader_1.ApkReader.open(this._gPlayUploaderConfig.apkFiles)];
                    case 1:
                        reader = _a.sent();
    ...
    GPlayUploader.prototype.uploadMultiplePaths = function (pathsToUpload, uploadSinglePathFunction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                uploadQue = [];
                pathsToUpload.forEach(function (filePath) { return __awaiter(_this, void 0, void 0, function () {
                    var newApkUpload;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, uploadSinglePathFunction(filePath)];
                            case 1:
                                newApkUpload = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this._logger("> Uploaded " + apkFilePath + " with version code " + apkUpload.data.versionCode + " and SHA1 " + apkUpload.data.binary.sha1);
                        return [2 /*return*/, apkUpload];
                }
            });
        });
    };
    GPlayUploader.prototype.uploadSingleOBB = function () {
        return __awaiter(this, void 0, void 0, function () {
                    ...
                    case 0:
                        ...
                        obbUploadConfig = {
                            ...
                            media: {
                                ...
                                body: fs_1.createReadStream('obbPath'),
                            },
                        };
