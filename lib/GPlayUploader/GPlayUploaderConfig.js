...
var GPlayUploaderConfig = /** @class */ (function () {
    function GPlayUploaderConfig(_a) {
        var configFilePath = _a.configFilePath, track = _a.track, authenticationPath = _a.authenticationPath, recentChanges = _a.recentChanges, apkFilePaths = _a.apkFilePaths, obbFilePaths = _a.obbFilePaths;
        this._recentChanges = [];
        this._apkFilePaths = [];
        this._obbFilePaths = [];
        ...
        set: function (value) {
            ...
            try {
                value.forEach(function (pathValue) {
                    _this._apkFilePaths.push(path.resolve(__dirname, pathValue));
                });
            }
            catch (e) {
    ...
    Object.defineProperty(GPlayUploaderConfig.prototype, "obbFilePaths", {
        ...
        set: function (value) {
            ...
            try {
                value.forEach(function (pathValue) {
                    _this._obbFilePaths.push(path.resolve(__dirname, pathValue));
                });
            }
            catch (e) {
                console.log('No OBBs.');
