...
var GPlayUploadProcess = /** @class */ (function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        oobUploadParameters = __assign({}, uploadParameters, {
                            versionCodes: GPlayUploadProcess.getVersionCodeFromUploadResults(uploadResults)
                        });
                        return [
                            4 /*yield*/,
                            this.fileUploader.uploadObbFilePaths(uploaderConfig.obbFilePaths, oobUploadParameters)
                        ];
                    case 4:
                        _a.sent();
                        trackUpdateParameters = __assign({}, oobUploadParameters, { track: uploaderConfig.track });
    ...
    GPlayUploadProcess.getVersionCodeFromUploadResults = function(uploadResults) {
