        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.sent();
                        return [4 /*yield*/, this.uploadMultiplePaths(this._gPlayUploaderConfig.apkFilePaths, this.uploadSingleAPK)];
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, this.uploadMultiplePaths(this._gPlayUploaderConfig.obbFilePaths, this.uploadSingleOBB)];
                    case 5:
                        _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, adbkit_apkreader_1.default.open(this._gPlayUploaderConfig.apkFilePaths[0])];
                    case 1:
                        reader = _a.sent();
