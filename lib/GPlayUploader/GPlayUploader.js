...
var node_aab_parser_1 = require('node-aab-parser');
var fs_1 = require('fs');
...
var GPlayUploader = /** @class */ (function() {
                    ...
                    case 3:
                        ...
                        return [
                            ...
                            this.uploadMultiplePaths(this._gPlayUploaderConfig.apkFilePaths, function(apkFilePath) {
                                return _this.uploadSinglePath(apkFilePath);
                            })
                        ];
                    case 4:
                        _b.sent();
                        return [
                            ...
                            this.uploadMultiplePaths(this._gPlayUploaderConfig.obbFilePaths, function(obbFilePath) {
                                return _this.uploadSinglePath(obbFilePath);
                            })
                        ];
                    case 5:
                        _b.sent();
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [
                            4 /*yield*/,
                            this.getPackageNameFromManifest(this._gPlayUploaderConfig.apkFilePaths[0])
                        ];
                    case 1:
                        _a.packageName = _b.sent();
    ...
    GPlayUploader.prototype.getPackageNameFromManifest = function(pathToPackage) {
        return __awaiter(this, void 0, void 0, function() {
            var manifest_1, manifest;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isAABFilePath(pathToPackage)) return [3 /*break*/, 2];
                        return [4 /*yield*/, node_aab_parser_1.readManifest(pathToPackage)];
                    case 1:
                        manifest_1 = _a.sent();
                        return [2 /*return*/, manifest_1.packageName];
                    case 2:
                        return [4 /*yield*/, adbkit_apkreader_1.default.open(pathToPackage).readManifest()];
                    case 3:
                        manifest = _a.sent();
                        return [4 /*yield*/, manifest.package];
                    case 4:
    ...
    GPlayUploader.prototype.isAABFilePath = function(path) {
    ...
    GPlayUploader.prototype.uploadSinglePath = function(filePath) {
        return __awaiter(this, void 0, void 0, function() {
            return __generator(this, function(_a) {
                if (this.isAABFilePath(filePath)) {
                    return [2 /*return*/, this.uploadSingleAppBundle(filePath)];
                }
                return [2 /*return*/, this.uploadSingleAPK(filePath)];
            });
        });
    };
    ...
    GPlayUploader.prototype.uploadSingleAppBundle = function(aabFilePath) {
        return __awaiter(this, void 0, void 0, function() {
            var uploadAabConfig, bundleUpload;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        uploadAabConfig = {
                            ...
                            editId: this.editId,
                            media: {
                                body: fs_1.createReadStream(aabFilePath)
                            }
                        };
                        return [4 /*yield*/, this.publisher.edits.bundles.upload(uploadAabConfig)];
                    case 1:
                        bundleUpload = _a.sent();
                        this.versionCodes.push(bundleUpload.data.versionCode.toString());
                        this._logger(
                            '> Uploaded ' +
                                aabFilePath +
                                ' with version code ' +
                                bundleUpload.data.versionCode +
                                ' and SHA1 ' +
                                bundleUpload.data.sha1
                        );
                        return [2 /*return*/, bundleUpload];
                }
            });
        });
    };
    ...
    GPlayUploader.prototype.getReleaseNotes = function() {
        var newReleaseNotes = [];
        this.logger('> Adding release notes');
