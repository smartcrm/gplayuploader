...
var GPlayUploader = /** @class */ (function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getManifestFromPath(this._gPlayUploaderConfig.apkFilePaths[0])];
                    case 1:
                        manifest = _a.sent();
    ...
    GPlayUploader.prototype.getManifestFromPath = function(path) {
        return __awaiter(this, void 0, void 0, function() {
            var reader;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isAABFilePath(path)) return [3 /*break*/, 2];
                        return [4 /*yield*/, node_aab_parser_1.readManifest(path)];
                    case 1:
                        return [2 /*return*/, _a.sent()];
                    case 2:
                        return [4 /*yield*/, adbkit_apkreader_1.default.open(path)];
                    case 3:
                        reader = _a.sent();
