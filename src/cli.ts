...
clear();
console.log(chalk.green(figlet.textSync('gpu-cli', { horizontalLayout: 'full' })));

program
    .description('How to use google-play-uploader')
    .option('-c, --config <file>', 'Configuration file for google-play-uploader')
    .option('-t, --track <track>', 'Track for uploading')
    .option('-a, --auth <authentication.json>', 'JSON file that contains private key and client email')
